...
class _OrderSummaryScreenState extends State<OrderSummaryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.guard == null) {
      ...
      _guardRecomendationCubit.guardRecomendation(
        ...
        startTime: "${widget.date.convert(format: "yyyy-MM-dd")} ${widget.startTime.padLeft(2, '0')}:00",
        endTime: "${widget.date.convert(format: "yyyy-MM-dd")} ${widget.endTime.padLeft(2, '0')}:00",
      );
    }
    ...
    return Column(
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Text('Penugasan Pribadi', style: xsSemiBold.copyWith(color: textDarkSecondary)),
        ...
        Row(
          ...
          children: [
            Text(
              '${hoursDiff} × ${widget.guardClass != null ? widget.guardClass?.hourlyPrice?.convertRupiah() : widget.guard?.guardClass?.hourlyPrice?.convertRupiah()}',
  ...
  Column _buildFormView() {
    ...
    return Column(
      ...
      children: [
        ...
        _infoTextView('Durasi', '${hoursDiff} Jam'),
        SizedBox(height: space400),
        _infoTextView('Tujuan Pengamanan', '${widget.reason}'),
        SizedBox(height: space400),
        _infoTextView('Jadwal mulai', '${widget.date.convert(format: "EEEE, d MMMM y")}, ${widget.startTime} WIB'),
        SizedBox(height: space400),
  ...
  */
  ...
  Widget _buildPromoView() {
    ...
    int finalPrice = totalPrice + (adminFee ?? 0) + (xenditFee ?? 0);
  ...
  TransactionRequest createTransactionRequest({
    ...
    return TransactionRequest(
      ...
      paymentMethodId: "726200b8-a577-407f-b696-af34e10db904",
      offlinePaymentMethodId: null,
