...
GuardHistoryModel _$GuardHistoryModelFromJson(Map<String, dynamic> json) =>
    GuardHistoryModel(
      id: json['id'] as String?,
      userId: json['user_id'] as String?,
      ...
      guardHistoryEquipmentSupports:
          (json['guard_history_equipment_supports'] as List<dynamic>?)
              ?.map((e) => GuardHistoryEquipmentSupportModel.fromJson(
                  e as Map<String, dynamic>))
              .toList(),
    );

Map<String, dynamic> _$GuardHistoryModelToJson(GuardHistoryModel instance) =>
    <String, dynamic>{
      'id': instance.id,
      'user_id': instance.userId,
      ...
      'guard_history_equipment_supports':
          instance.guardHistoryEquipmentSupports,
    };
