...
//
//     final agencyByIdModel = agencyByIdModelFromJson(jsonString);

import 'package:json_annotation/json_annotation.dart';
import 'dart:convert';

part 'agency_by_id_model.g.dart';

AgencyByIdModel agencyByIdModelFromJson(String str) => AgencyByIdModel.fromJson(json.decode(str));

String agencyByIdModelToJson(AgencyByIdModel data) => json.encode(data.toJson());
...
class AgencyByIdModel {
  ...
  factory AgencyByIdModel.fromJson(Map<String, dynamic> json) => _$AgencyByIdModelFromJson(json);

  Map<String, dynamic> toJson() => _$AgencyByIdModelToJson(this);
}
